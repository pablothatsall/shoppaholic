...
@Component({
  ...
  export class SignUpComponent {
    ...
    constructor(private router:Router, private loginService:LoginService, private userService:CustomerService){
    ...
    signUp(event:any,firstname:string, lastname:string, email:string, password:string, address:string, telephone:number){
